...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2020-04-21")
public class UpdateService {

    public interface Iface {

        public void update(java.util.List<ConcertDTO> lista) throws org.apache.thrift.TException;

    }

    public interface AsyncIface {

        public void update(java.util.List<ConcertDTO> lista, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void send_update(java.util.List<ConcertDTO> lista) throws org.apache.thrift.TException
        {
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public void update(java.util.List<ConcertDTO> lista, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
            checkReady();
            update_call method_call = new update_call(lista, resultHandler, this, ___protocolFactory, ___transport);
            this.___currentMethod = method_call;
            ___manager.call(method_call);
        }

        public static class update_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
            private java.util.List<ConcertDTO> lista;
            public update_call(java.util.List<ConcertDTO> lista, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
        ...
        public static class update<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, update_args, Void> {
            ...
            public void start(I iface, update_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
                iface.update(args.lista,resultHandler);
            }
        }
    ...
    public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable, Comparable<update_args>   {
        ...
        public @org.apache.thrift.annotation.Nullable java.util.List<ConcertDTO> lista; // required
        ...
        public update_args(
                java.util.List<ConcertDTO> lista)
        {
            this();
            this.lista = lista;
        }
        ...
        public update_args(update_args other) {
            if (other.isSetLista()) {
                java.util.List<ConcertDTO> __this__lista = new java.util.ArrayList<ConcertDTO>(other.lista.size());
                for (ConcertDTO other_element : other.lista) {
                    __this__lista.add(new ConcertDTO(other_element));
                }
        ...
        @org.apache.thrift.annotation.Nullable
        public java.util.Iterator<ConcertDTO> getListaIterator() {
            return (this.lista == null) ? null : this.lista.iterator();
        }

        public void addToLista(ConcertDTO elem) {
            if (this.lista == null) {
                this.lista = new java.util.ArrayList<ConcertDTO>();
            }
            this.lista.add(elem);
        }

        @org.apache.thrift.annotation.Nullable
        public java.util.List<ConcertDTO> getLista() {
            return this.lista;
        }

        public update_args setLista(@org.apache.thrift.annotation.Nullable java.util.List<ConcertDTO> lista) {
            this.lista = lista;
            return this;
        }
            ...
            switch (field) {
                case LISTA:
                    if (value == null) {
                        ...
                        setLista((java.util.List<ConcertDTO>)value);
                    }
                    break;
        ...
        public int hashCode() {
            ...
            hashCode = hashCode * 8191 + ((isSetLista()) ? 131071 : 524287);
            if (isSetLista())
                hashCode = hashCode * 8191 + lista.hashCode();
        ...
        public int compareTo(update_args other) {
            ...
            lastComparison = java.lang.Boolean.valueOf(isSetLista()).compareTo(other.isSetLista());
            if (lastComparison != 0) {
        ...
        private static class update_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<update_args> {
                            ...
                            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                                {
                                    ...
                                    struct.lista = new java.util.ArrayList<ConcertDTO>(_list16.size);
                                    @org.apache.thrift.annotation.Nullable ConcertDTO _elem17;
                                    for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                                    {
                                        _elem17 = new ConcertDTO();
                                        _elem17.read(iprot);
                                        struct.lista.add(_elem17);
                                    }
                                    iprot.readListEnd();
                                }
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, update_args struct) throws org.apache.thrift.TException {
                ...
                if (struct.lista != null) {
                    ...
                    {
                        oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.lista.size()));
                        for (ConcertDTO _iter19 : struct.lista)
                        {
                            _iter19.write(oprot);
                        }
                        oprot.writeListEnd();
                ...
                if (struct.isSetLista()) {
                    {
                        ...
                        for (ConcertDTO _iter20 : struct.lista)
                        {
                            _iter20.write(oprot);
                        }
                    }
                ...
                if (incoming.get(0)) {
                    {
                        ...
                        struct.lista = new java.util.ArrayList<ConcertDTO>(_list21.size);
                        @org.apache.thrift.annotation.Nullable ConcertDTO _elem22;
                        for (int _i23 = 0; _i23 < _list21.size; ++_i23)
                        {
                            _elem22 = new ConcertDTO();
                            _elem22.read(iprot);
                            struct.lista.add(_elem22);
                        }
                    }
                    struct.setListaIsSet(true);
                }
